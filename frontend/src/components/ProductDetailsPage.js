...
function ProductDescriptionPage() {
  ...
  const handleFormSubmit = (e) => {
    ...
    console.log("Form Data with Payment Method:", formDataWithPayment);
  };
      ...
      <div className="product-description">
        <div className="booking-card">
          ...
          <div className="movie-details">
            ...
            <p className="movie-ratings">Price: Rs{product.price}</p> {/* Added this line */}
  </div>
        </div>
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="form-group">
              ...
              >
                ...
                <option value="city2">Ahemdabad</option>
                <option value="city3">Vadodara</option>
                <option value="city4">Rajkot</option>
                <option value="city5">Porbandar</option>
                <option value="city6">Mumbai</option>
                <option value="city7">New Delhi</option>
              </select>
              ...
              />
              {/* <label className="form-label">Select Cinema House:</label>
              {cinemaHouses.map((cinemaHouse) => (
                <label key={cinemaHouse.id} className="checkbox-label">
                  <input
                    type="checkbox"
                    name="cinemaHouse"
                    value={cinemaHouse.id}
                    checked={selectedCinemaHouse === cinemaHouse.id}
                    onChange={handleCinemaHouseChange}
                  />
                  
                  {cinemaHouse.name}
                </label>
              ))} */}
              <label htmlFor="cinemaHouse" className="form-label">
                Cinema House
              </label>
              <select
                id="cinemaHouse"
              ...
              >
                ...
                <option value="cinema1">Miraj Cinemas</option>
                <option value="cinema2">Apple Multiplex</option>
                <option value="cinema3">Cinemax Shows</option>
                <option value="cinema4">PVR Acropolis</option>
                <option value="cinema5">Rajhans Cinemas</option>
                <option value="cinema6">Rupam Multiplex</option>
                <option value="cinema7">Wide Angle</option>
                <option value="cinema8">Inox Multiplex</option>
              </select>
              <label>Timing </label>
              <select
